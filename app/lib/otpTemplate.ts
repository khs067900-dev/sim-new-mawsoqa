  ...
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:480px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px -1px rgba(0,0,0,0.05);">
    <tr>
      <td style="padding:32px 24px;text-align:center;">
        <h2 style="margin:0 0 12px;font-size:20px;font-weight:700;color:#0A1C29;">رمز التحقق</h2>
        <p style="margin:0 0 24px;font-size:15px;color:#64748b;line-height:1.5;">استخدم الرمز التالي لتأكيد حسابك وإتمام تسجيلك:</p>
        ...
        <p style="margin:0 0 8px;font-size:13px;color:#94a3b8;">الرمز صالح لمدة 10 دقائق.</p>
